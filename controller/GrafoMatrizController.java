...
public class GrafoMatrizController {
	...
	public void roteriza() throws Exception {
		...
		gFabrica.link("Vitoria","Campos dos Goytacazes", 240);
		...
		//Links Centro1
		gCentroUm.link("Ribeirao Preto","Franca",89); //Distribuidora
		gCentroUm.link("Ribeirao Preto","Sao Carlos",99); //Distribuidora
		...
		gCentroUm.link("Ribeirao Preto","Uberlandia",278); //Distribuidora
		...
		System.out.println(gFabrica.toString());
		System.out.println(gCentroUm.toString());
		System.out.println(gCentroDois.toString());
	}
	
	// Correr a matriz por níveis até encontrar a cidade desejada e voltar printando
	// Cada linha é um nível
	// Cada coluna é um cidade
}